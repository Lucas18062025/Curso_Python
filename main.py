...
def root() -> dict[str, str]:
    """Root endpoint for health check / friendly landing.

    Returns:
        A simple status message so hitting the base URL doesn't 404.
    """
    return {"status": "ok", "message": "API funcionando. Ver /docs para la documentación."}
